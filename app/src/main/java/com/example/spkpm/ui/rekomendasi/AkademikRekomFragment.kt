...
class AkademikRekomFragment : Fragment(), RekomendasiNilaiView {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_akademik_rekom, container, false)
        // init layout
        ...
        sr?.setOnRefreshListener {
            ...
            presenter.getRekomNilaiBySwipeRefresh(1)
